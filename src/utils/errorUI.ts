/**
 * Simple, unopinionated UI that surfaces errors to the user. Returns a single error message. Use "span#err" for styling.
 */
...
export class ErrorUI {
     ...
     * @param type type of DOM element type the error should be, ex. span, h1, p. Not required.
     * @param id add an ID for styling. Not required.
     */
